...
from troute.DataAssimilation import DataAssimilation, _newer_seed
...
class Model:
    ...
    def load_state(self, data: dict):
        ...
        # The diversion rows were filled at init, before this restore, so the seed
        # alone would change nothing: re-run the fill from the pre-fill rows.
        # The later of the checkpoint's seed and what init found in the record.
        da._diversion_seed_in = _newer_seed(da._diversion_seed_in, data.get("diversion_seed"))
        da.refill_diversion_rows()
        da._diversion_applied = dict(data.get("diversion_applied") or {})
